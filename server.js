...
const express = require("express"),
  ...
  app = express(),
  // Get the root path where the file is stored in
  path = require("path"),
  // Extracts body portion of incoming req stream
  bodyParser = require("body-parser"),
  // Database
  mongodb = require("mongodb"),
  MongoClient = mongodb.MongoClient,
  // Environment variable where our db is

  URI = process.env.MONGODB_URI || "mongodb://localhost:27017/magic_trick",
